...
Bootstrap inicial do frontend do marketplace UGC com React Router Framework Mode, Vite e TypeScript strict.
...
## Estrutura
- `app/routes`: rotas finas
- `app/modules`: dominios da aplicacao
