  ...
  return (
    <section className="space-y-4 pb-6">
      ...
      <div className="px-4">
        <div className="rounded-[32px] border border-[rgba(137,90,246,0.05)] bg-white p-4 shadow-sm">
          <div className="flex items-center justify-between">
            <button type="button" className="rounded-full p-2 text-[#895af6]">
              <ArrowLeft className="size-4" />
            </button>
            <h2 className="text-lg font-bold text-slate-900">Outubro 2023</h2>
            <button type="button" className="rounded-full p-2 text-[#895af6]">
      ...
      <div className="px-4">
        <button
          type="button"
          onClick={() => controller.actions.setIsMobileAvailabilityOpen(true)}
          ...
          >
            ...
            <div className="space-y-4 p-5">
              ...
              <div className="space-y-2 text-sm text-slate-500">
                ...
                <div className="flex items-center gap-2">
                  {job.location.includes("Meet") ? <Video className="size-4" /> : <MapPin className="size-4" />}
                  {job.location}
                </div>
              </div>
              {job.description ? (
