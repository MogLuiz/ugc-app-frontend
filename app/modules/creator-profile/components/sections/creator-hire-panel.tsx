...
function PanelContainer({
  ...
  return (
    <section
      ...
      role="dialog"
      className={cn(
        "relative flex bg-white shadow-[0px_24px_80px_rgba(15,23,42,0.28)]",
        desktop
