...
const HERO_ILLUSTRATION =
  "https://www.figma.com/api/mcp/asset/949a1aca-b468-470d-b2fd-caf4ee94a38d";

export function BusinessDashboardExploreHero() {
  return (
    <section className="relative overflow-hidden rounded-2xl bg-white p-6 shadow-[0px_4px_6px_-1px_rgba(106,54,213,0.04),0px_20px_40px_-1px_rgba(44,47,48,0.08)] lg:flex lg:items-center lg:gap-8 lg:p-8">
      <div className="pointer-events-none absolute -right-20 -top-20 size-64 rounded-full bg-[rgba(106,54,213,0.05)] blur-[32px]" aria-hidden />
      ...
      <div className="relative z-[1] mt-6 flex justify-center lg:mt-0 lg:w-[200px] lg:shrink-0">
        <img
          src={HERO_ILLUSTRATION}
          alt=""
          className="h-36 w-auto object-contain opacity-95 lg:h-44"
          loading="lazy"
        />
      </div>
    </section>
